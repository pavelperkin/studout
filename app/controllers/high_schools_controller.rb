class HighSchoolsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @high_school.save
        format.html { redirect_to high_schools_path, notice: 'High school was successfully created.' }
        format.json { render action: 'show', status: :created, location: @high_school }
      else
  ...
  private
    ...
    def high_school_params
      params.require(:high_school).permit(:name)
    end
end
